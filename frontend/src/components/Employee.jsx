  ...
  return (
    <div className='h-100 w-100'>
      <div className="p-2 bg-info text-dark w-100 text-start text-uppercase" style={{display:'flex',justifyContent:'space-between',cursor:'pointer'}} ><b>WELCOME {details[0]?.name || "Employee"}</b>
        <div style={{marginRight:'2%'}} onClick={()=>setAi(<GroqChatDirect />)}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" className="bi bi-chat-text" viewBox="0 0 16 16">
