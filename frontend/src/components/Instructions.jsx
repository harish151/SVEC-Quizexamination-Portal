...
function Instructions(props) {
    ...
    const handleexam = (e)=>{
      e.preventDefault();
      goFullscreen();
      navigate("/exam",{state:{name:name,batch:batch,branch:branch,coursecode:coursecode,examtype:examtype,semester:semester,section:section,username:username,session:true}});
    }
    const goFullscreen = () => {
